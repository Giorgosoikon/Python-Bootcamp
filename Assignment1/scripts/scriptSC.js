...
function readFormData() {
    ...
    formData["tuitionfee"] = document.getElementById("tuitionfee").value;
...
function insertNewRecord(data) {
    ...
    cell4.innerHTML = data.tuitionfee;
...
function onEdit(td) {
    ...
    document.getElementById("tuitionfee").value = selectedRow.cells[3].innerHTML;
...
function updateRecord(formData) {
    ...
    selectedRow.cells[3].innerHTML = formData.tuitionfee;
